...
\entry{Broken Vector UG}{Jan 2017 --- Jul 2020}{Founder \& Managing Director}{Eichenau}{%
  \ifCV
    Broken Vector developed and sold (Virtual Reality (VR)) software as well as 3D models in various online stores.
  \fi
  \begin{itemize}[noitemsep, nosep]
...
\entry{Amazon Web Services EMEA SARL}{Oct 2020 --- Feb 2021}{Solutions Architect Intern}{Munich}{%
  ...
  \begin{itemize}[noitemsep, nosep]
    ...
    \item Directly consulted customers about AWS's cloud offerings and proposed architectures
    \item Built proof of concepts of cloud architectures for customers
  \end{itemize}
}
}
...
\entry{Lohr IT}{Dec 2015 --- Present}{Owner}{Eichenau}{%
  ...
  \begin{itemize}[noitemsep, nosep]
    ...
    \item Developing web applications and container-based backend software
  \end{itemize}
}
}

\WorkHideOnResume(8)=t
\Work(8)={%
...
\entry{Filics GmbH}{Aug 2021 --- Dec 2021}{Project Study: Fault-Tolerant Cloud-based Monitoring Architectures for Robotics}{Garching}{%
  ...
  \begin{itemize}[noitemsep, nosep]
    ...
    \else
      ...
      \item Investigated different Cloud Computing solutions for robot/IoT appliances
...
\Work(10)={%
\entry{STABL Energy GmbH}{Jan 2022 --- Sep 2022}{Cloud Architect, Working Student}{Munich}{%
  % \ifCV
  %   STABL Energy develops smart, safe, reliable, and cost-effective battery storage systems.
  % \fi
  \begin{itemize}[noitemsep, nosep]
    \item Planned and implemented a fault‑tolerant and scalable monitoring/logging architecture inside the AWS Cloud
    \ifSHORT
    \else
      \item Developed software to securely connect microcontrollers to the Cloud
    \fi
  \end{itemize}
}
}
...
\Work(11)={%
\entry{STABL Energy GmbH}{Okt 2022 --- Present}{Junior Solutions Architect}{Munich}{%
  \ifCV
    STABL Energy develops smart, safe, reliable, and cost-effective battery storage systems.
  \fi
  \begin{itemize}[noitemsep, nosep]
    \item Building up and managing the cloud team at STABL
    \item Designing and implementing a cloud‑based system to ingest and analyze large amounts of near‑realtime data
    \ifSHORT
    \else
      \item Architecting a platform to control battery storage systems remotely
      \item Leading the development of FreeRTOS-based IoT devices written in Rust
      \item Managing enterprise software and network solutions for the different departments
    \fi
  \end{itemize}
}
}
