...
\entry{STABL Energy GmbH}{Jan 2022 --- Sep 2022}{Cloud Architect, Working Student}{Munich}{%
  ...
  % \fi
  \begin{itemize}[noitemsep, nosep]
    \item Planned a fault-tolerant and scalable monitoring/logging architecture based on the AWS Cloud
    \item Developed software to connect microcontrollers to the Cloud in a secure way
  \end{itemize}
}
}

\Work(11)={%
\entry{STABL Energy GmbH}{Okt 2022 --- Present}{Junior Cloud Architect}{Munich}{%
  \ifCV
    STABL Energy develops smart, safe, reliable, and cost-effective battery storage systems.
  \fi
  \begin{itemize}[noitemsep, nosep]
    \item Designing and implementing a Cloud-based system to ingest and analyze large amounts of near-realtime data
    \item Developing a platform to remotely control battery storage system deployments
    \item Overseeing the development of cloud-connected edge devices
