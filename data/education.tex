...
\Education(4)={%
  \entry{Technical University Munich}{2019 --- 2022}{Master of Science (M.Sc.), Informatics}{Garching}{%
    ...
    \begin{itemize}[noitemsep, nosep]
      ...
      \item In my master's thesis, I presented a novel generic cloud architecture format and transpiler software to deploy to different cloud platforms without platform-specific knowledge (graded 1.0/A+)
    \end{itemize}
  }
}
